...
## HTTPS for zingcargo.com and www.zingcargo.com
Run on VPS after DNS is active:

```bash
sudo apt -y install certbot python3-certbot-nginx
sudo certbot --nginx -d zingcargo.com -d www.zingcargo.com
```

Then update /var/www/tracking_web/.env and restart:
...
sudo systemctl restart tracking_web
```
